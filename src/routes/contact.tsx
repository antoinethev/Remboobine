      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 py-16 md:grid-cols-2">
        <div>
          ...
          <div className="mt-10 rounded-2xl border border-primary/10 bg-cream/70 p-6 text-sm text-primary/70">
            ...
            <p className="mt-2">Les deux sont possibles. Pour un envoi, un service suivi type Mondial Relay convient parfaitement. Nous confirmons la réception dès l'ouverture du colis.</p>
          </div>
        </div>
